export interface LearnerWorkTask {
    id: number;
    title: string;
...
export interface LearnerWorkData {
    learnerName: string;
    avatarClass: string;
    tasks: LearnerWorkTask[];
}

const learnerWork: LearnerWorkData = {
    learnerName: "Md. Samiur Rahman",
...
export function getLearnerWork(): LearnerWorkData {
    return learnerWork;
}
