...
export function StreamHero({
    ...
    return (
        <>
            ...
            <header className="rounded-2xl border border-slate-200/90 border-t-4 border-t-indigo-600 bg-white p-5 shadow-xs dark:border-slate-800/90 dark:border-t-indigo-500 dark:bg-slate-900/90">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    {/* Left: Category Breadcrumbs, Title, Meta Chips */}
                    <div className="flex items-start gap-4 min-w-0 flex-1">
                        {/* Course Icon Badge */}
                        <div className="hidden sm:flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 border border-indigo-100 dark:bg-indigo-950/60 dark:text-indigo-400 dark:border-indigo-800/60 shadow-2xs">
