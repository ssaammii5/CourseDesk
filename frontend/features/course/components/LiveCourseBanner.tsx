...
interface LiveCourseBannerProps {
    nextSession: SessionDto | null;
    scheduleNotes?: string;
    isEnrolled: boolean;
}
export type LiveClassBannerProps = LiveCourseBannerProps;

export function LiveCourseBanner({
    nextSession,
    scheduleNotes,
    isEnrolled,
}: LiveCourseBannerProps) {
...
export const LiveClassBanner = LiveCourseBanner;