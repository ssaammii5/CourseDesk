...
type TabType = "student-work" | "instructions";
...
export function TeacherAssignmentView({
    ...
    const [tab, setTab] = useState<TabType>("student-work");
    ...
    const filteredSubmissions = useMemo(() => {
        return submissions.filter((s) => {
            ...
            const studentEmail = (s.studentEmail ?? "").toLowerCase();
            const studentId = (s.studentAcademicId ?? "").toLowerCase();
            const q = search.toLowerCase();

            const matchSearch = !q || studentName.includes(q) || studentEmail.includes(q) || studentId.includes(q);
                ...
                <div className="mx-auto flex max-w-[1200px] flex-col gap-3 px-4 pt-4 sm:px-8">
                    ...
                    <nav className="flex gap-8 border-t border-gray-100">
                        <button
                            ...
                            className={`relative flex cursor-pointer items-center gap-2 py-3 text-sm font-medium transition-colors ${tab === "student-work"
                                ? "text-[#1a73e8]"
                    ...
                    {loadingSubmissions ? (
                        ...
                        <div className="mt-10 rounded-xl border border-gray-200 bg-gray-50 py-16 text-center">
                            ...
                            <p className="text-xs text-gray-500">
                                {statusFilter !== "All"
                                    ? `No student work matches the "${statusFilter}" filter.`
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                            {/* Left: Student Info & Submitted Content */}
                                            <div className="min-w-0 flex-1">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-500">
                                                            {sub.studentEmail}
                                                            {sub.studentAcademicId && ` • ID: ${sub.studentAcademicId}`}
                                                        </p>
                                                    </div>
